          ...
          <div className="relative h-[500px] lg:h-[600px] flex items-center justify-center">
            ...
            <div className="absolute bottom-20 left-10 animate-helix-rotate">
              <svg width="60" height="200" viewBox="0 0 60 200" className="drop-shadow-lg">
                {/* Left Strand */}
                <path d="M15 10 Q30 50 15 90 Q0 130 15 170 Q30 190 15 200" stroke="hsl(var(--mustard-500))" strokeWidth="3" fill="none" opacity="0.8" />
                {/* Right Strand */}
                <path d="M45 10 Q30 50 45 90 Q60 130 45 170 Q30 190 45 200" stroke="hsl(var(--mustard-400))" strokeWidth="3" fill="none" opacity="0.8" />
                {/* Rungs */}
            ...
            <div className="absolute top-40 left-1/2 transform -translate-x-1/2 animate-drift">
              <svg width="200" height="100" viewBox="0 0 200 100" className="drop-shadow-lg">
                <path d="M20 50 Q60 20 100 50 Q140 80 180 50" stroke="hsl(var(--mustard-500))" strokeWidth="4" fill="none" opacity="0.7" strokeLinecap="round" />
                <path d="M20 55 Q60 25 100 55 Q140 85 180 55" stroke="hsl(var(--mustard-400))" strokeWidth="2" fill="none" opacity="0.5" strokeLinecap="round" />
              </svg>
            </div>
