...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-mustard-600 shadow-soft hover:shadow-mustard",
        mustard: "bg-mustard-500 text-true-black font-semibold hover:bg-mustard-600 shadow-soft hover:shadow-mustard",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-soft",
        outline:
          "border-2 border-border bg-background hover:bg-accent hover:text-accent-foreground shadow-soft",
        "outline-light":
          "border-2 border-zinc-600 bg-transparent text-near-white hover:bg-near-white hover:text-true-black shadow-soft",
        secondary:
