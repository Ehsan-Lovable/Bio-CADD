...
WITH CHECK (
  ...
  AND OLD.course_id = NEW.course_id  -- Cannot change course_id
  AND OLD.submitted_at = NEW.submitted_at  -- Cannot change submission time
);
...
INSERT INTO public.audit_log (
  ...
  jsonb_build_object(
    ...
    'description', 'Fixed enrollment submissions access control to prevent competitor data access'
  )
);